            ...
            <table class="table table-striped table-dark">
                ...
                <tbody>
                    ...
                    <%
                        ...
                        ArrayList<Usuario> usuarios = usuarioBD.obtenerUsuarios(conexion.getConexion());
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-info btn-sm" data-toggle="modal" data-target="#exampleModal<%=usuario.getId()%>">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>¿Seguro que deseas eliminar de forma permanente a <br>[<%=usuario.getNombre()%>]?</p>
                                        </div>
